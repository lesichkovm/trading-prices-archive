...
TICKER_META = {
    ...
    'ULVR.L': {'asset_class': 'eu', 'exchange': 'lse',    'instrument_id': 'lse_ulvr',      'name': 'Unilever plc',                      'slug': 'ulvr'},
    'HSBA.L': {'asset_class': 'eu', 'exchange': 'lse',    'instrument_id': 'lse_hsba',      'name': 'HSBC Holdings plc',                 'slug': 'hsba'},
    'LLOY.L': {'asset_class': 'eu', 'exchange': 'lse',    'instrument_id': 'lse_lloy',      'name': 'Lloyds Banking Group plc',          'slug': 'lloy'},
    'BARC.L': {'asset_class': 'eu', 'exchange': 'lse',    'instrument_id': 'lse_barc',      'name': 'Barclays plc',                      'slug': 'barc'},
    'RIO.L':  {'asset_class': 'eu', 'exchange': 'lse',    'instrument_id': 'lse_rio',       'name': 'Rio Tinto Group',                   'slug': 'rio'},
    'GLEN.L': {'asset_class': 'eu', 'exchange': 'lse',    'instrument_id': 'lse_glen',      'name': 'Glencore plc',                      'slug': 'glen'},
    'BATS.L': {'asset_class': 'eu', 'exchange': 'lse',    'instrument_id': 'lse_bats',      'name': 'British American Tobacco plc',      'slug': 'bats'},
    'IMB.L':  {'asset_class': 'eu', 'exchange': 'lse',    'instrument_id': 'lse_imb',       'name': 'Imperial Brands plc',               'slug': 'imb'},
    'DGE.L':  {'asset_class': 'eu', 'exchange': 'lse',    'instrument_id': 'lse_dge',       'name': 'Diageo plc',                        'slug': 'dge'},
    'REL.L':  {'asset_class': 'eu', 'exchange': 'lse',    'instrument_id': 'lse_rel',       'name': 'Relx plc',                          'slug': 'rel'},
    'LSEG.L': {'asset_class': 'eu', 'exchange': 'lse',    'instrument_id': 'lse_lseg',      'name': 'London Stock Exchange Group plc',   'slug': 'lseg'},
    'PRU.L':  {'asset_class': 'eu', 'exchange': 'lse',    'instrument_id': 'lse_pru',       'name': 'Prudential plc',                    'slug': 'pru'},
    'AV.L':   {'asset_class': 'eu', 'exchange': 'lse',    'instrument_id': 'lse_av',        'name': 'Aviva plc',                         'slug': 'av'},
    'CNA.L':  {'asset_class': 'eu', 'exchange': 'lse',    'instrument_id': 'lse_cna',       'name': 'Centrica plc',                      'slug': 'cna'},
    'TSCO.L': {'asset_class': 'eu', 'exchange': 'lse',    'instrument_id': 'lse_tsco',      'name': 'Tesco plc',                         'slug': 'tsco'},
    # Crypto
